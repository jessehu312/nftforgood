        ...
        <div className="flex flex-col justify-center mx-16 bg-pri-indigo">
          ...
          <div className="w-full">
            <div className="inline-block mb-32 w-full md:w-5/12">
              <label className="group w-full transition-colors flex flex-col items-center px-4 py-6 bg-transparent text-blue rounded-lg shadow-lg tracking-wide uppercase border-4 border-blue hover:border-yellow-400 cursor-pointer hover:text-white border-dashed py-12">
                <svg
                  className="transform-colors duration-150 ease-in-out group-hover:text-yellow-400 text-white w-8 h-8"
                  fill="currentColor"
                ...
                <span className="transform-colors duration-150 ease-in-out group-hover:text-yellow-400 text-white mt-2 text-base leading-normal">
                  Select a file
                </span>
                <input
