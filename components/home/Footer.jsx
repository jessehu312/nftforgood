          ...
          <div className="w-full flex flex-col sm:flex-row justify-between">
            <div className="flex flex-col justify-start">
              ...
              <div className="flex flex-row space-x-4 mt-4">
                <div className="w-12 h-12 bg-yellow-400 rounded-full flex flex-row justify-center items-center cursor-pointer">
                  <a
        ...
        <div className="max-w-screen-xl mx-auto sm:px-8 pt-8 pb-16 xl:px-0">
          <div className="flex flex-col sm:flex-row justify-between">
            ...
            <div className="flex flex-row space-x-8">
              ...
              <h5 className="text-xs text-gray-400">© 2021 NFT4Good</h5>
            </div>
          </div>
        </div>
      </div>
